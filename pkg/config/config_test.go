...
func TestGetConfig_EnvVars(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name: "MetricsServerPort - invalid port 0",
			envVars: map[string]string{
				"NGINX_PROXY_MANAGER_HOST":     "npm.example.com",
				"NGINX_PROXY_MANAGER_PASSWORD": "password",
				"NGINX_PROXY_MANAGER_USERNAME": "user",
		...
		{
			name: "MetricsServerPort - invalid port -1",
			envVars: map[string]string{
				"NGINX_PROXY_MANAGER_HOST":     "npm.example.com",
				"NGINX_PROXY_MANAGER_PASSWORD": "password",
				"NGINX_PROXY_MANAGER_USERNAME": "user",
		...
		{
			name: "MetricsServerPort - invalid port 65536",
			envVars: map[string]string{
				"NGINX_PROXY_MANAGER_HOST":     "npm.example.com",
				"NGINX_PROXY_MANAGER_PASSWORD": "password",
				"NGINX_PROXY_MANAGER_USERNAME": "user",
				"PIHOLE_HOST":                  "pihole.example.com",
				"PIHOLE_PASSWORD":              "pihole_pass",
				"METRICS_SERVER_PORT":          "65536",
			},
			expectedConfig: nil,
			expectErr:      true,
		},
		{
			name: "MetricsServerPort - invalid port 100000",
			envVars: map[string]string{
				"NGINX_PROXY_MANAGER_HOST":     "npm.example.com",
				"NGINX_PROXY_MANAGER_PASSWORD": "password",
				"NGINX_PROXY_MANAGER_USERNAME": "user",
				"PIHOLE_HOST":                  "pihole.example.com",
				"PIHOLE_PASSWORD":              "pihole_pass",
				"METRICS_SERVER_PORT":          "100000",
			},
			expectedConfig: nil,
			expectErr:      true,
		},
		{
			name: "MetricsServerPort - boundary valid port 1",
			envVars: map[string]string{
				"NGINX_PROXY_MANAGER_HOST":     "npm.example.com",
				"NGINX_PROXY_MANAGER_PASSWORD": "password",
				"NGINX_PROXY_MANAGER_USERNAME": "user",
		...
		{
			name: "MetricsServerPort - boundary valid port 65535",
			envVars: map[string]string{
				"NGINX_PROXY_MANAGER_HOST":     "npm.example.com",
				"NGINX_PROXY_MANAGER_PASSWORD": "password",
				"NGINX_PROXY_MANAGER_USERNAME": "user",
			...
			expectedConfig: &Config{
				...
				PiholeHost:          "pihole.example.com",
				PiholePassword:      "pihole_pass",
				MetricsServerPort:   65535,
				RunInterval:         5 * time.Minute,
			},
			expectErr: false,
		},
		{
			name: "MetricsServerPort - custom valid port 8080",
			envVars: map[string]string{
				"NGINX_PROXY_MANAGER_HOST":     "npm.example.com",
				"NGINX_PROXY_MANAGER_PASSWORD": "password",
				"NGINX_PROXY_MANAGER_USERNAME": "user",
